module tb_processing_element;
    ...
    task automatic check_result(
        ...
        if(a !== b) begin
            $display("===== t=%0t FAILED =====\nExpected : signed=%0d | unsigned=%0u\nActual   : signed=%0d | unsigned=%0u\n", $time, $signed(a), $unsigned(a), $signed(b), $unsigned(b));
        end
        else begin
    ...
    initial begin
        ...
        $display("\n===== Case 1: Reset Check =====");
        rst_n = 0;
        act = -16'sd1; wei = 16'sd1; pipeline_en = 1; Thres = 2'b00; cscan_en = 0; cell_en = 1; cell_sc_en = 1; reg_clear = 0;
        repeat (STAGE + 3) @(posedge clk);
        #1;
        check_bit(1'b0, cell_out);
        check_bit(1'b0, c_switch_out);
        check_act_wei(16'sd0, wei_out);
        check_act_wei(16'sd00, act_out);
        check_result(48'sd0, MAC_out);
        act = 16'h2; wei = 16'h2;
        repeat (STAGE + 3) @(posedge clk);
        #1;
        check_bit(1'b0, cell_out);
        check_bit(1'b0, c_switch_out);
        check_act_wei(16'sd0, wei_out);
        check_act_wei(16'sd0, act_out);
        check_result(48'sd0, MAC_out);

        $display("\n===== Case 2: Reg_clr Signal Check =====");
        rst_n = 1;
        reg_clear = 0; act = -16'sd1; wei = 16'sd1; pipeline_en = 1; Thres = 2'b00; cscan_en = 0; cell_en = 1; cell_sc_en = 1;
        repeat (STAGE + 3) @(posedge clk);
        #1;
        check_bit(1'b1, cell_out);
        check_bit(1'b0, c_switch_out);
        check_act_wei(16'sd1, wei_out);
        check_act_wei(-16'sd1, act_out);
        check_result(-48'sd1, MAC_out);
        reg_clear = 1;
        repeat (STAGE + 3) @(posedge clk);
        #1;
        check_bit(1'b0, cell_out);
        ...
        check_act_wei(16'sd0, act_out);
        check_result(48'sd0, MAC_out);
        reg_clear = 0; act = -16'sd2; wei = 16'sd2; pipeline_en = 1; Thres = 2'b00; cscan_en = 0; cell_en = 1; cell_sc_en = 1;
        repeat (STAGE + 3) @(posedge clk);
        #1;
        check_bit(1'b1, cell_out);
        check_bit(1'b0, c_switch_out);
        check_act_wei(16'sd2, wei_out);
        check_act_wei(-16'sd2, act_out);
        check_result(-48'sd4, MAC_out);
        ...
        #1;
        reg_clear = 0;
        act = 16'sd1; wei = -16'sd1; pipeline_en = 1; Thres = 2'b00; cscan_en = 0; cell_en = 1; cell_sc_en = 1;
        repeat (STAGE + 3) @(posedge clk);
        #1;
        check_bit(1'b1, cell_out);
        check_bit(1'b0, c_switch_out);
        ...
        check_act_wei(16'sd1, act_out);
        check_result(-48'sd1, MAC_out);
        act = -16'sd2; wei = 16'sd2; pipeline_en = 1; Thres = 2'b00; cscan_en = 0; cell_en = 1; cell_sc_en = 1;
        repeat (STAGE + 3) @(posedge clk);
        #1;
        check_bit(1'b1, cell_out);
        check_bit(1'b0, c_switch_out);
        check_act_wei(16'sd2, wei_out);
        check_act_wei(-16'sd2, act_out);
        check_result(-48'sd15, MAC_out);
        act = -16'sd3; wei = 16'sd3; pipeline_en = 1; Thres = 2'b00; cscan_en = 0; cell_en = 1; cell_sc_en = 1;
        repeat (STAGE + 3) @(posedge clk);
        #1;
        check_bit(1'b1, cell_out);
        check_bit(1'b0, c_switch_out);
        check_act_wei(16'sd3, wei_out);
        check_act_wei(-16'sd3, act_out);
        check_result(-48'sd57, MAC_out);

        cell_en = 0;
        act = -16'sd4; wei = -16'sd4; pipeline_en = 1; Thres = 2'b00; cscan_en = 0; cell_sc_en = 1;
        repeat (STAGE + 3) @(posedge clk);
        #1;
        check_bit(1'b1, cell_out);
        check_bit(1'b0, c_switch_out);
        ...
        //CHECK STOP
        act = -16'sd2; wei = 16'sd2; pipeline_en = 0; Thres = 2'b00; cscan_en = 0; cell_en = 1; cell_sc_en = 1;
        repeat (STAGE + 3) @(posedge clk);                          //OFF
        #1;                                                         
        check_bit(1'b1, cell_out);
        check_bit(1'b0, c_switch_out);
        ...
        check_act_wei(-16'sd3, wei_out);
        check_act_wei(16'sd3, act_out);
        check_result(-48'sd16, MAC_out);                              //7 clk counting 16-25-34-43-52-61-70
  
        //CHECK STOP
        act = 16'sd4; wei = -16'sd4; pipeline_en = 0; Thres = 2'b00; cscan_en = 0; cell_en = 1; cell_sc_en = 1;
        @(posedge clk);                          //OFF 
        #1;                                                 
        check_bit(1'b1, cell_out);
        check_bit(1'b0, c_switch_out);
        ...
        act = 16'sd5; wei = -16'sd5; pipeline_en = 1; Thres = 2'b00; cscan_en = 0; cell_en = 1; cell_sc_en = 1;
        @(posedge clk);                                             //Wait for MAC_OUT come
        #1;
        check_bit(1'b1, cell_out);
        check_bit(1'b0, c_switch_out);
        check_act_wei(-16'sd5, wei_out);
        check_act_wei(16'sd5, act_out);
        check_result(-48'sd25, MAC_out);
        ...
        check_act_wei(-16'sd5, wei_out);
        check_act_wei(16'sd5, act_out);
        check_result(-48'sd95, MAC_out);                              //7 clk counting 95-120-145-170-195-220-245

        //CHECK STOP
        act = 16'sd6; wei = -16'sd6; pipeline_en = 0; Thres = 2'b00; cscan_en = 0; cell_en = 1; cell_sc_en = 1;          
        @(posedge clk);                          //OFF                         
        #1;                    
        check_bit(1'b1, cell_out);
        check_bit(1'b0, c_switch_out);
        ...
        check_bit(1'b1, cell_out);
        check_bit(1'b0, c_switch_out);
        check_act_wei(-16'sd6, wei_out);
        check_act_wei(16'sd6, act_out);
        check_result(-48'sd120, MAC_out); 
        ...
        #1;
        reg_clear = 0; cell_en = 1; pipeline_en = 1; cscan_en = 0; cell_sc_en = 1;
        MAC_in = 100; c_switch = 0; act = 16'sd1; wei = -16'sd1;
        repeat (STAGE + 3) @(posedge clk);                          
        #1;                    
        check_bit(1'b1, cell_out);
        check_bit(1'b0, c_switch_out);
        ...
        MAC_in = 100; c_switch = 1; act = 16'sd2; wei = -16'sd2;
        @(posedge clk);                          
        #1;                    
        check_bit(1'b1, cell_out);
        check_bit(1'b0, c_switch_out);
        ...
        #1;
        reg_clear = 0; cell_en = 1; pipeline_en = 1;
        act = 16'sd10; wei = -16'sd10; cscan_en = 0; cell_sc_en = 1;
        repeat (STAGE + 3) @(posedge clk); 
        #1;                    
        check_bit(1'b1, cell_out);
        check_bit(1'b0, c_switch_out);
        check_act_wei(-16'sd10, wei_out);
        check_act_wei(16'sd10, act_out);
        check_result(-48'sd100, MAC_out);             //100-200-300-400-500-600-700 (after reg_clear)

        act = 0; wei = -16'sd20; cscan_en = 0; cell_sc_en = 1;
        repeat (STAGE + 1) @(posedge clk); 
        #1;                    
        check_bit(1'b1, cell_out);
        check_bit(1'b0, c_switch_out);
        check_act_wei(-16'sd20, wei_out);
        check_act_wei(16'sd0, act_out);
        check_result(-48'sd700, MAC_out);
        ...
        act = 16'sd30; wei = -16'sd30; cscan_en = 0; cell_sc_en = 1;   //after 8 cycle new act and wei will be push
        repeat(STAGE + 3) @(posedge clk);        
        #1;                    
        check_bit(1'b1, cell_out);
        check_bit(1'b0, c_switch_out);
        check_act_wei(-16'sd30, wei_out);
        check_act_wei(16'sd30, act_out);
        check_result(-48'sd1600, MAC_out);            //1600-2500-3400-4300-5200-6100-7000

        act = -16'sd40; wei = 16'sd0; cscan_en = 0; cell_sc_en = 1;
        repeat (STAGE + 3) @(posedge clk); 
        #1;                    
        check_bit(1'b1, cell_out);
        check_bit(1'b0, c_switch_out);
        check_act_wei(16'sd0, wei_out);
        check_act_wei(-16'sd40, act_out);
        check_result(-48'sd7000, MAC_out);  
        ...
        #1;
        reg_clear = 0; cell_en = 1; pipeline_en = 1;    
        act = 16'sd10; wei = -16'sd10; cscan_en = 0; cell_sc_en = 1; MAC_in = 2;
        repeat (STAGE + 3) @(posedge clk);                              //8clk
        #1;                     
        check_bit(1'b1, cell_out);
        check_bit(1'b0, c_switch_out);
        check_act_wei(-16'sd10, wei_out);
        check_act_wei(16'sd10, act_out);
        check_result(-48'sd100, MAC_out);                                 //100-900 (10clk - 1 reset clk)

        //Transmit MAC_in OUTPUT
        cscan_en = 1; cell_sc_en = 1; MAC_in = 2;
        @(posedge clk);                                                 //1clk
        #1;                    
        check_bit(1'b1, cell_out);
        check_bit(1'b0, c_switch_out);
        ...
        check_act_wei(-16'sd10, wei_out);
        check_act_wei(16'sd10, act_out);
        check_result(-48'sd300, MAC_out);

        act = 16'sd20; wei = -16'sd20; cscan_en = 1; cell_sc_en = 1; MAC_in = 1000;
        @(posedge clk);                                                 //1clk 
        #1;                    
        check_bit(1'b1, cell_out);
        check_bit(1'b0, c_switch_out);
        check_act_wei(-16'sd20, wei_out);
        check_act_wei(16'sd20, act_out);
        check_result(48'd1000, MAC_out);
        ...
        act = -16'sd20; wei = 16'sd20; cscan_en = 1; cell_sc_en = 1; MAC_in = 20000;
        @(posedge clk); 
        #1;                    
        check_bit(1'b1, cell_out);
        check_bit(1'b0, c_switch_out);
        ...
        check_act_wei(16'sd20, wei_out);
        check_act_wei(-16'sd20, act_out);
        check_result(-48'sd1300, MAC_out);
        ...
        check_act_wei(16'sd20, wei_out);
        check_act_wei(-16'sd20, act_out);
        check_result(-48'sd1400, MAC_out);
